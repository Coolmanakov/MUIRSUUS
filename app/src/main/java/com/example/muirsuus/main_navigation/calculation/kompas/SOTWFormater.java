package com.example.muirsuus.main_navigation.calculation.kompas;
 ...
 */
public class SOTWFormater {
    private static final int[] sides = {0, 45, 90, 135, 180, 225, 270, 315, 360};
    private static String[] names = null;

    public SOTWFormater(Kompas context) {
        initLocalizedNames(context.getContext());
    }
