...
public class SubscriberNetworkRepository {
    ...
    public static String mDivisionType = "";
    public static String mControlPointType = "";
    ...
    public static ArrayList<String> getList(SpinnerMap mapName) {
        switch (mapName) {
            case OFFICIAL_MAP:
                return officialMap.get(mDivisionType);
            case CONTROL_POINT_MAP:
                return controlPointMap.get(mDivisionType);
            default:
                return new ArrayList<>(emptyList());
        }
    }
